...
//	У методі main() ініціалізувати створення екземплярів класу та 
//	продемонструвати роботу його методів згідно умов завдання.
...
//	радіус вписаного, радіус описаного кола, тип трикутника (рівносторонній, рівнобедрений,
//	прямокутний, гострокутний, тупокутний), поворот на заданий кут відносно (однієї з вершин,
//	центру описаного кола).
